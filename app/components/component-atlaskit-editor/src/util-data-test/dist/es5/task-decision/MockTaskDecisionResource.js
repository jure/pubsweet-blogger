...
var MockTaskDecisionResource = /** @class */ (function () {
    ...
    MockTaskDecisionResource.prototype.getDecisions = function (query) {
        ...
        var serviceDecisionResponse = story_data_1.getServiceDecisionsResponse();
        var result = task_decision_1.convertServiceDecisionResponseToDecisionResponse(serviceDecisionResponse);
    ...
    MockTaskDecisionResource.prototype.getTasks = function (query) {
        ...
        var serviceTasksResponse = story_data_1.getServiceTasksResponse();
        var result = task_decision_1.convertServiceTaskResponseToTaskResponse(serviceTasksResponse);
    ...
    MockTaskDecisionResource.prototype.getItems = function (query) {
        ...
        var serviceItemResponse = story_data_1.getServiceItemsResponse();
        var result = task_decision_1.convertServiceItemResponseToItemResponse(serviceItemResponse);
    ...
    MockTaskDecisionResource.prototype.getCurrentUser = function () {
        ...
        var randomParticipant = Math.floor(Math.random() * story_data_1.participants.length);
        return Math.random() < 0.75 ? story_data_1.participants[randomParticipant] : undefined;
    };
